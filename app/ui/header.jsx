...
export default function Header() {
  ...
  return (
    <nav className="px-[5%] lg:px-[10%] bk-image-content py-3 flex items-center justify-between">
      ...
      <Image src="/logo.svg" width={180} height={100} alt="logo" className="w-[150px] md:w-[180px]" />
      <Image
        src={session?.user?.profilePicture}
        width={50}
        height={50}
        alt="profile pics"
        className="rounded-full border-white border-4 h-[50px] object-cover object-top"
      />
    </nav>
  );
}
